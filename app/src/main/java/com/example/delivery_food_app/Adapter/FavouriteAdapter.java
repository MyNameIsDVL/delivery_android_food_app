...
public class FavouriteAdapter extends RecyclerView.Adapter<FavouriteAdapter.FavouriteViewHolder> {
    ...
    public FavouriteAdapter(Context context, List<Favourite> basketFood) {
        this.context = context;
        this.favouriteFood = basketFood;
    }

    @NonNull
    @Override
    public FavouriteAdapter.FavouriteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.favourite_view_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull FavouriteAdapter.FavouriteViewHolder holder, int position) {
        ...
        Favourite food = favouriteFood.get(position);
